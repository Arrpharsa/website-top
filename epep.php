...
$result = $koneksi->query("SELECT * FROM epep");
    ...
    <style>
        * {
        ...
        .game-image {
            width: 100%;
            height: 250px;
            background-image: url('https://gamebrott.com/wp-content/uploads/2024/04/Capai-100-Juta-Pemain-1024x576.webp');
...
<body>
    <div class="container">
        ...
        <div class="game-image">
            <div class="game-info">
                <h3>Free Fire</h3>
                <p>Top up Diamond Free Fire dengan harga terbaik dan proses instan. Nikmati berbagai bonus dan promo menarik untuk setiap transaksi!</p>
            </div>
        </div>

        <form action="epepproses.php" method="POST">
            ...
            <div class="topup-section">
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) { 
                        ...
                        echo "<span>" . $row['FDM'] . " Diamonds <div class='diamond-icon'></div></span>";
