...
$result = $koneksi->query("SELECT * FROM hok");
    ...
    <style>
        * {
        ...
        .game-image {
            width: 100%;
            height: 250px;
            background-image: url('https://awsimages.detik.net.id/community/media/visual/2024/06/20/honor-of-kings-resmi-rilis-di-android-dan-ios-ini-spek-hp-buat-main_169.png?w=1200');
    ...
    <div class="container">
        ...
        <div class="game-image">
            <div class="game-info">
                ...
                <p>Top up Token Honor Of Kings dengan harga terbaik dan proses instan. Nikmati berbagai bonus dan promo menarik untuk setiap transaksi!</p>
            </div>
        </div>

        <form action="hokproses.php" method="POST">
            ...
            <div class="topup-section">
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) { 
                        ...
                        echo "<span>" . $row['HokTokens'] . " Tokens <div class='diamond-icon'></div></span>";
