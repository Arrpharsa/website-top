...
$result = $koneksi->query("SELECT * FROM aov");
    ...
    <style>
        * {
        ...
        .game-image {
            width: 100%;
            height: 250px;
            background-image: url('https://statik.tempo.co/data/2018/06/25/id_714331/714331_720.jpg');
    ...
    <div class="container">
        ...
        <div class="game-image">
            <div class="game-info">
                ...
                <p>Top up Vouchers Arena of Valor dengan harga terbaik dan proses instan. Nikmati berbagai bonus dan promo menarik untuk setiap transaksi!</p>
            </div>
        </div>
            ...
            <div class="topup-section">
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) { 
                        ...
                        echo "<span>" . $row['AovVouchers'] . " Vouchers <div class='diamond-icon'></div></span>";
    ...
    <div id="strukModal" class="struk-modal">
        <div class="struk-content">
            <div class="struk-header">
                <h2>TOP UP GAME</h2>
                <p>Arena of Valor</p>
                <p>Game Mobile MOBA Terpopuler</p>
                <p>www.arenaofvalor.com</p>
            </div>
