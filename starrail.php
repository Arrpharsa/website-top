...
$result = $koneksi->query("SELECT * FROM starrail");
    ...
    <style>
        * {
        ...
        .diamond-icon {
            ...
            background-image: url('os-removebg-preview.png');
...
<body>
    <div class="container">
        ...
        <form action="index.html" method="POST" onsubmit="return confirm('Apakah Anda Yakin ID Sudah Benar?');">
            <div class="input-section">
                <div class="input-container">
                    <input type="text" name="user_id" placeholder="User ID" class="input-field" required>
                    <input type="text" name="user_id" placeholder="Server" class="input-field" required>
                </div>
            ...
            <div class="topup-section">
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) { 
                        ...
                        echo "<span>" . $row['OneiricShard'] . " Oneiric Shard <div class='diamond-icon'></div></span>";
