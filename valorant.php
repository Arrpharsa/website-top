...
$result = $koneksi->query("SELECT * FROM valorant");
    ...
    <style>
        * {
        ...
        .game-image {
            width: 100%;
            height: 250px;
            background-image: url('https://cdn1.epicgames.com/offer/cbd5b3d310a54b12bf3fe8c41994174f/EGS_VALORANT_RiotGames_S1_2560x1440-1dade6e50659c8e05805cb150b349e56');
        ...
        .diamond-icon {
            ...
            background-image: url('vp-removebg-preview.png');
            background-size: cover;
            background-position: center;
...
<body>
    <div class="container">
        ...
        <div class="game-image">
            <div class="game-info">
                <h3>Valorant</h3>
                <p>Top up VP Valorant dengan harga terbaik dan proses instan. Nikmati berbagai bonus dan promo menarik untuk setiap transaksi!</p>
            </div>
        </div>

        <form action="valorantproses.php" method="POST">
            ...
            <div class="topup-section">
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) { 
                        ...
                        echo "<span>" . $row['VP'] . " VP <div class='diamond-icon'></div></span>";
    ...
    <div id="strukModal" class="struk-modal">
        <div class="struk-content">
            <div class="struk-header">
                <h2>TOP UP GAME</h2>
                <p>Valorant</p>
                <p>Game FPS Taktis Terpopuler</p>
                <p>www.valorant.com</p>
            </div>
