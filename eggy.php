...
$result = $koneksi->query("SELECT * FROM eggyparty");
    ...
    <style>
        * {
        ...
        .game-image {
            width: 100%;
            height: 250px;
            background-image: url('https://assets.nintendo.com/image/upload/ar_16:9,c_lpad,w_1240/b_white/f_auto/q_auto/ncom/software/switch/70010000082675/d5e28fa075fb7b94bc3192207d429451e0cdde5e3bd890d0868d9243c0edbee6');
...
<body>
    <div class="container">
        ...
        <div class="game-image">
            <div class="game-info">
                <h3>Eggy Party</h3>
                <p>Top up Eggy Coins Eggy Party dengan harga terbaik dan proses instan. Nikmati berbagai bonus dan promo menarik untuk setiap transaksi!</p>
            </div>
        </div>

        <form action="eggyproses.php" method="POST">
            ...
            <div class="topup-section">
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) { 
                        ...
                        echo "<span>" . $row['ECoins'] . " Eggy Coins <div class='diamond-icon'></div></span>";
    ...
    <div id="strukModal" class="struk-modal">
        <div class="struk-content">
            <div class="struk-header">
                <h2>TOP UP GAME</h2>
                <p>Eggy Party</p>
                <p>Game Party Mobile Terpopuler</p>
                <p>www.eggyparty.com</p>
            </div>
