...
$result = $koneksi->query("SELECT * FROM genshin");
...
<head>
    ...
    <style>
        * {
        ...
        .game-image {
            width: 100%;
            height: 250px;
            background-image: url('https://i.ytimg.com/vi/qqnEjmnitgc/maxresdefault.jpg');
        ...
        .diamond-icon {
            ...
            background-image: url('primogem-removebg-preview.png');
            background-size: cover;
            background-position: center;
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const strukServer = document.getElementById('strukServer');
            ...
            form.addEventListener('submit', function(e) {
                ...
                modalServer.textContent = server;
            ...
            confirmBtn.addEventListener('click', function() {
                ...
                strukServer.textContent = document.querySelector('input[name="server"]').value;
        ...
        function closeStruk() {
            ...
            window.location.href = 'genshin.php';
        }
    ...
    <div class="container">
        ...
        <div class="game-image">
            <div class="game-info">
                ...
                <p>Top up Primogem Genshin Impact dengan harga terbaik dan proses instan. Nikmati berbagai bonus dan promo menarik untuk setiap transaksi!</p>
            </div>
        </div>

        <form action="genshinproses.php" method="POST">
            <div class="input-section">
                <div class="input-container">
                    <input type="text" name="user_id" placeholder="UID" class="input-field" required>
                    <input type="text" name="server" placeholder="Server" class="input-field" required>
                </div>
                <p>Silahkan Masukkan UID & Server Anda Dan Pastikan Benar.</p>
            </div>
            ...
            <div class="topup-section">
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) { 
                        ...
                        echo "<span>" . $row['Primogem'] . " Primogem <div class='diamond-icon'></div></span>";
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-data">
                    <p>UID: <span id="modalUserId"></span></p>
                    <p>Server: <span id="modalServer"></span></p>
    ...
    <div id="strukModal" class="struk-modal">
        <div class="struk-content">
            <div class="struk-header">
                <h2>TOP UP GAME</h2>
                <p>Genshin Impact</p>
                <p>Game RPG Open World Terpopuler</p>
                <p>www.genshin.mihoyo.com</p>
            </div>
