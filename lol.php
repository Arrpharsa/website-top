...
$result = $koneksi->query("SELECT * FROM lol");
    ...
    <style>
        * {
        ...
        .game-image {
            width: 100%;
            height: 250px;
            background-image: url('https://cmsassets.rgpub.io/sanity/images/dsfx7636/news_live/3705653167ef8f43acdc03fb2f0a469d5b3086fd-1920x1080.jpg');
        ...
        .diamond-icon {
            ...
            background-image: url('lol-removebg-preview.png');
            background-size: cover;
            background-position: center;
    ...
    <div class="container">
        ...
        <div class="game-image">
            <div class="game-info">
                ...
                <p>Top up Wild Cores League Of Legends dengan harga terbaik dan proses instan. Nikmati berbagai bonus dan promo menarik untuk setiap transaksi!</p>
            </div>
        </div>

        <form action="lolproses.php" method="POST">
            ...
            <div class="topup-section">
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) { 
                        ...
                        echo "<span>" . $row['WildCores'] . " Wild Cores <div class='diamond-icon'></div></span>";
    ...
    <div id="strukModal" class="struk-modal">
        <div class="struk-content">
            <div class="struk-header">
                ...
                <p>Game MOBA PC Terpopuler</p>
                <p>www.leagueoflegends.com</p>
            </div>
